...
function _login() {
  _login = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, loginForm, btn) {
    var response;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              ...
              (0, _alert.showAlert)(response.data.status, 'Logged In Successfully');
              btn.textContent = 'Done :)'; // 2. Redirect to home page after short delay
          ...
          case 7:
            ...
            document.querySelector('.auth-errors').innerHTML = _context.t0.response.data.message;
...
function _signup() {
  _signup = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, signupForm, btn) {
    var response;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              // 1. Show alert that user is signuped
              (0, _alert.showAlert)(response.data.status, 'Signed Up Successfully');
              btn.textContent = 'Done :)'; // 2. Redirect to home page after short delay
          ...
          case 7:
            ...
            if (_context.t0.response.data.problemFields) {
              Object.entries(_context.t0.response.data.problemFields).forEach(function (_ref) {
                var _ref2 = _slicedToArray(_ref, 2),
                    key = _ref2[0],
                    value = _ref2[1];

                var inputDom = signupForm.querySelector("input[name=".concat(key, "]"));
                inputDom.style.border = "red 1px solid";
                document.querySelector('.auth-errors').innerHTML += "".concat(value, "<br />");
              });
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"wishlist.js":[function(require,module,exports) {
"use strict";
...
var setWishListSize = function setWishListSize(wishListSize) {
  var dom = document.getElementById('user-wish-list');
...
function _addBook() {
  _addBook = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(dom) {
    var _dom$dataset, title, author, url, image, price, onlinePrice, source, response;
...
function removeBook(_x2) {
  return _removeBook.apply(this, arguments);
}

function _removeBook() {
  _removeBook = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(dom) {
    var url, response;
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"updateTopBooks.js":[function(require,module,exports) {
"use strict";
...
function _ref() {
  _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(dom, btn) {
    var response;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              (0, _alert.showAlert)(response.data.status, 'Books Updated');
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"sendContactMessage.js":[function(require,module,exports) {
"use strict";
...
function _ref() {
  _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, btn, form) {
    var response;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              (0, _alert.showAlert)(response.data.status, 'Message sent, thank you for your support', 3000);
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alert.showAlert)('error', 'Problem with sending, try again later');
...
var displayEmailSent = function displayEmailSent(email) {
  var authContent = document.querySelector('.auth-content');
  authContent.insertAdjacentHTML('beforebegin', "<h2 style=\"height: 40vh; text-align: center; padding-top: 100px\">Email sent to ".concat(email, ", check your inbox!<br/>Check Spam Folder!</h2>"));
  authContent.style.display = 'none';
};

var sendEmail = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(email, button) {
    var response;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              (0, _alert.showAlert)(response.data.status, "Email sent to ".concat(email, ", check your inbox"));
          ...
          case 7:
            ...
            if (_context.t0.response.data.message === 'There is no user with given email') {
              (0, _alert.showAlert)("Email sent to ".concat(email, ", check yout inbox"));
              displayEmailSent(email);
            } else {
              (0, _alert.showAlert)('error', 'Problem with sending email, please try again');
...
var resetPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(data, token, button, form) {
    var response;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/users/password-reset/".concat(token),
              data: data
            });
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              (0, _alert.showAlert)(response.data.status, 'Password reset');
          ...
          case 7:
            ...
            document.querySelector('.auth-errors').innerHTML = _context2.t0.response.data.message;
  ...
  return function resetPassword(_x3, _x4, _x5, _x6) {
...
exports.updatePassword = exports.updateName = void 0;
...
var updateName = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, btn, form) {
    var response;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              (0, _alert.showAlert)(response.data.status, "Name changed, you are now: ".concat(response.data.data.user.name));
              form.querySelectorAll('input').forEach(function (el) {
                el.style.border = '';
                el.value = '';
              });
              form.querySelector('.auth-errors').innerHTML = '';
              form.querySelector('.user-current-name').textContent = "Name: ".concat(response.data.data.user.name);
            }
          ...
          case 7:
            ...
            if (_context.t0.response.data.problemFields) {
              Object.entries(_context.t0.response.data.problemFields).forEach(function (_ref2) {
                var _ref3 = _slicedToArray(_ref2, 2),
                    key = _ref3[0],
                    value = _ref3[1];

                var inputDom = form.querySelector("input[name=".concat(key, "]"));
                inputDom.style.border = "red 1px solid";
                document.querySelector('.auth-errors').innerHTML += "".concat(value, "<br />");
              });
            }
  ...
  return function updateName(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
var updatePassword = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(data, btn, form) {
    var response;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              (0, _alert.showAlert)(response.data.status, "Password changed");
              form.querySelectorAll('input').forEach(function (el) {
                el.style.border = '';
                el.value = '';
              });
...
var _updateTopBooks = _interopRequireDefault(require("./updateTopBooks"));

var _sendContactMessage = _interopRequireDefault(require("./sendContactMessage"));

var passwordReset = _interopRequireWildcard(require("./passwordReset"));

var updateUser = _interopRequireWildcard(require("./updateUser"));
...
var selectOptions = document.getElementById('per_page');
var checkBox = document.querySelector('.filters-select');
var signupForm = document.querySelector('.signup-form');
var loginForm = document.querySelector('.login-form');
var addWishList = document.querySelectorAll('.addWishList');
var updateTopBooksBtn = document.querySelector('.update-top-books-btn');
var passwordForgotForm = document.querySelector('.password-forgot-form');
...
if (contactForm) {
  contactForm.addEventListener('submit', function (event) {
    ...
    var btn = contactForm.querySelector('.contact-btn');
...
if (checkBox) {
  if (urlParams.has('select')) {
    var selectArr = urlParams.getAll('select')[0].split(' ');

    if (selectArr.length > 1 || selectArr[0] !== '') {
      checkBox.querySelectorAll('input').forEach(function (el) {
...
if (searchForm) {
  searchForm.addEventListener('submit', function (event) {
    ...
    if (input === '') return;
    var limit = selectOptions ? document.getElementById('per_page').value : 48;
    var select = checkBox ? Array.from(checkBox.querySelectorAll('input')).reduce(function (acc, curr) {
      return curr.checked ? acc + curr.value + '+' : acc;
    }, '').slice(0, -1) : '';
    location.assign("/pretraga?search=".concat(input, "&limit=").concat(limit, "&select=").concat(select));
  });
}
...
if (updateTopBooksBtn) {
  updateTopBooksBtn.addEventListener('click', function (event) {
    event.preventDefault();
    updateTopBooksBtn.disabled = true;
    updateTopBooksBtn.textContent = 'Processing....';
    var paragraphDom = document.querySelector('.top-books-update-info');
    (0, _updateTopBooks.default)(paragraphDom, updateTopBooksBtn);
  });
}

if (passwordForgotForm) {
  passwordForgotForm.addEventListener('submit', function (event) {
    var sendBtn = passwordForgotForm.querySelector('.send-btn');
    sendBtn.textContent = 'Sending...';
    sendBtn.disabled = true;
    event.preventDefault();
    var email = passwordForgotForm.querySelector('input[name="email"]').value.trim().toLowerCase();
...
if (passwordResetForm) {
  passwordResetForm.addEventListener('submit', function (event) {
    event.preventDefault();
    var resetBtn = passwordResetForm.querySelector('.reset-password-btn');
    resetBtn.textContent = 'Processing...';
    resetBtn.disabled = true;
    var password = passwordResetForm.querySelector('input[name="password"]').value.trim();
    var passwordConfirm = passwordResetForm.querySelector('input[name="passwordConfirm"]').value.trim();
    var token = passwordResetForm.dataset.token;
    passwordReset.resetPassword({
      password: password,
      passwordConfirm: passwordConfirm
    }, token, resetBtn, passwordResetForm);
  });
  passwordResetForm.querySelectorAll('input').forEach(function (el) {
    el.addEventListener('focus', function (e) {
      e.target.style.border = '';
    });
  });
...
if (updateUserForm) {
  updateUserForm.addEventListener('submit', function (event) {
    event.preventDefault();
    var updateBtn = updateUserForm.querySelector('.update-user-btn');
    updateBtn.textContent = 'Processing...';
    updateBtn.disabled = true;
    var name = updateUserForm.querySelector('input[name="name"]').value.trim();
    updateUser.updateName({
      name: name
    }, updateBtn, updateUserForm);
  });
  updateUserForm.querySelectorAll('input').forEach(function (el) {
    el.addEventListener('focus', function (e) {
      e.target.style.border = '';
    });
  });
