...
var displayEmailSent = function displayEmailSent(email) {
  ...
  authContent.insertAdjacentHTML('beforebegin', "<h2 style=\"height: 40vh; text-align: center; padding-top: 100px\">Email sent to ".concat(email, ", check your inbox!</h2>"));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              (0, _alert.showAlert)(response.data.status, "Email sent to ".concat(email, ", check yout inbox"));
